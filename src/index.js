...
const  moveLeft = (e)=>{
    ...
    if(slider.scrollWidth - slider.scrollLeft > document.documentElement.offsetWidth ){
       slider.scrollLeft -= document.documentElement.offsetWidth
    }
...
const  moveRight = (e)=>{
    ...
    if(document.documentElement.offsetWidth < slider.scrollWidth - document.documentElement.offsetWidth ){
        slider.scrollLeft += document.documentElement.offsetWidth
    }
    else{
        slider.scrollLeft = slider.scrollWidth - document.documentElement.offsetWidth
    }
}
